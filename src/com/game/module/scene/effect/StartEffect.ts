class StartEffect {
    ...
    private init(): void {
        var factory: dragonBones.EgretFactory = App.resource.getDragonFactory("NXT_1");
        this._dragonbones = factory.buildArmatureDisplay("vs");
        this._dragonbones.scaleX = this._dragonbones.scaleY = 0.8
    }
    ...
    public show(parent: egret.DisplayObjectContainer, x?: number, y?: number, callBack?: FunctionVo): void {
        ...
        this._dragonbones.animation.gotoAndPlayByFrame("vs", 1, 1);
